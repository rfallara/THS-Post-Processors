...
function onOpen() {
    ...
    if (getProperty("SB3v36")) {
        // calls up the My_Variables file to set user variables from a predefined list.
...
function onClose() {
    ...
    writeBlock("CN, 91"); //check for possibly running a metric file when the software/controller is in inch mode.
    writeBlock("END");
}
